      ...
      <div className="footer" id="footer">
        <div className="footer-content">
          <div className="footer-section">
            ...
            <p>
              Nikmati suasana santai dengan menu khas yang menggoda selera. Kami
              percaya bahwa makanan tidak hanya sekadar rasa, tetapi juga
              pengalaman.
            </p>
          ...
          <div className="footer-section">
            ...
            <ul>
              <li>
                <i className="fas fa-home"></i> <a href="/">Beranda</a>
              </li>
              <li>
                <i className="fas fa-utensils"></i> <a href="/menu">Menu</a>
              </li>
              <li>
          ...
          <div className="footer-section">
            ...
            <ul>
              ...
              <li>
                📍 Jl. Ampera No.57 Bulak, Kec. Jatibarang, Kab. Indramayu
              </li>
            </ul>
          </div>
        </div>
