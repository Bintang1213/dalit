...
const KelolaKeuangan = () => {
  ...
  const filteredOrders = filterTransaksi(); // --- Perbaikan Logika Flattened Data: paymentMethod dan itemName sudah benar ---
  ...
  const handleUnduhPDF = () => {
    const doc = new jsPDF();
    const pageWidth = doc.internal.pageSize.getWidth(); // Header
    ...
    doc.text(title, (pageWidth - textWidth) / 2, 15); // Periode
    ...
    autoTable(doc, {
      startY: 28, // Perbaikan Header: Pesanan (Item Name) diikuti Metode Pembayaran
      head: [
        [
          "No",
          "Tanggal",
    ...
    const afterTableY = doc.lastAutoTable.finalY || 35; // Total pemasukan
    ...
    autoTable(doc, {
      ...
      theme: "grid",
      head: [
        ["", "", "", "", "", "Total Pemasukan", `Rp ${total.toLocaleString()}`],
      ],
      headStyles: {
        ...
        <table className="tabel-keuangan">
          ...
          <thead>
            ...
            <tr>
              ...
                    <th>Harga Per Item</th>              <th>Jumlah</th>       
                    <th>Total</th>           {" "}
            </tr>
                     {" "}
          </thead>
              ...
              <>
                ...
                {currentData.map((item, index) => {
                  ...
                  const isFirstItemOfOrderOnPage =
                    index === 0 ||
                    currentData[index - 1].orderId !== item.orderId;
